...
| Data layer scaffolding (layered projects) | `code-architect` | `efcore-patterns`, `database-performance`, `csharp-coding-standards`, `package-management`, `project-structure` | `documentation-lookup`, `superpowers:test-driven-development`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.Domain/**, src/Lms.Application/**, src/Lms.Infrastructure/**, src/Lms.Api/Program.cs, src/Lms.Api/Lms.Api.csproj, Directory.Packages.props, Lms.slnx` | `worktree` |
| Aspire orchestration change | `code-architect` | `aspire-configuration`, `csharp-coding-standards`, `opentelementry-dotnet-instrumentation`, `package-management` | `documentation-lookup`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.AppHost/**, src/Lms.ServiceDefaults/**, Directory.Packages.props` | `worktree` |
| EF migration authoring | `code-architect` | `efcore-patterns`, `package-management` | `documentation-lookup`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.Infrastructure/Migrations/**, src/Lms.Migrations/**, Directory.Packages.props` | `worktree` |
