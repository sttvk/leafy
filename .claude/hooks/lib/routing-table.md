...
| New .NET endpoint | `tdd-guide` → `general-purpose` | `api-design`, `efcore-patterns`, `csharp-coding-standards`, `tdd-workflow`, `csharp-testing` | `superpowers:test-driven-development`, `superpowers:verification-before-completion`, `documentation-lookup` | `csharp-reviewer`, `security-reviewer` (if auth), `contract-sync-bot` (if DTOs changed), `superpowers:verification-before-completion` | `src/Lms.Api/Endpoints/**, src/Lms.Api/Services/**, src/Lms.Api/Dtos/**, tests/Lms.Api.Tests/**` | `worktree` |
| Data layer scaffolding (layered projects) | `general-purpose` | `efcore-patterns`, `database-performance`, `csharp-coding-standards`, `package-management`, `project-structure` | `documentation-lookup`, `superpowers:test-driven-development`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.Domain/**, src/Lms.Application/**, src/Lms.Infrastructure/**, src/Lms.Api/Program.cs, src/Lms.Api/Lms.Api.csproj, Directory.Packages.props, Lms.slnx` | `worktree` |
| Aspire orchestration change | `general-purpose` | `aspire-configuration`, `csharp-coding-standards`, `opentelementry-dotnet-instrumentation`, `package-management` | `documentation-lookup`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.AppHost/**, src/Lms.ServiceDefaults/**, Directory.Packages.props` | `worktree` |
| EF migration authoring | `general-purpose` | `efcore-patterns`, `package-management` | `documentation-lookup`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.Infrastructure/Migrations/**, src/Lms.Migrations/**, Directory.Packages.props` | `worktree` |
| React page / component | `general-purpose` | `frontend-patterns`, `react-data-fetching`, `frontend-design` | `superpowers:test-driven-development`, `frontend-design:frontend-design`, `documentation-lookup`, `superpowers:verification-before-completion` | `typescript-reviewer`, `frontend-design:frontend-design` (spot-check), `superpowers:verification-before-completion` | `client/src/pages/**, client/src/components/**, client/src/api/**, client/src/hooks/**, client/src/types/**` | `worktree` |
