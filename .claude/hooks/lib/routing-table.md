...
| Data layer scaffolding | `code-architect` | `efcore-patterns`, `database-performance`, `csharp-coding-standards`, `package-management` | `documentation-lookup`, `superpowers:test-driven-development`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.Api/Data/**, src/Lms.Api/Program.cs, Directory.Packages.props` | `worktree` |
...
| EF migration authoring | `code-architect` | `efcore-patterns`, `package-management` | `documentation-lookup`, `superpowers:verification-before-completion` | `csharp-reviewer`, `superpowers:verification-before-completion` | `src/Lms.Api/Data/Migrations/**, src/Lms.Migrations/**, Directory.Packages.props` | `worktree` |
